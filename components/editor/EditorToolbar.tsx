...
export function EditorToolbar({
  ...
  if (loading) {
    return (
      <div className="sticky top-0 z-10 flex items-center justify-start xl:justify-center gap-0.5 px-4 py-2 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-black overflow-x-auto">
