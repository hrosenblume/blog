...
export function EssayLink({ slug, title, subtitle, polyhedraShape, index }: EssayLinkProps) {
  ...
  return (
    <Link
      ...
      className="group block w-full text-left border-b border-border transition-all duration-200 interactive-bg-accent can-hover:hover:shadow-sm can-hover:hover:-translate-y-0.5 px-6 py-5"
    >
